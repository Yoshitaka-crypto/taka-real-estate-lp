...
export default function Home() {
    ...
    // セクション内コンテナ（幅制限・中央寄せ）
    const sectionInner = "max-w-4xl mx-auto px-6 sm:px-8"

    // 共通カードスタイル（内側余白広め・シャドウで馴染み）
    const cardItem =
        "max-w-4xl mx-auto rounded-3xl border border-[#062447]/20 border-gray-100/50 " +
        "bg-white/40 backdrop-blur-md shadow-md " +
        "px-8 sm:px-10 py-8 sm:py-10"

    // カードスタック（縦の間隔）
    const cardStack = "max-w-4xl mx-auto space-y-6 sm:space-y-8"

    // 大きめカード（プロフィール・フォーム等・内側ゆとり）
    const largeCard = "bg-white/[0.62] border border-white/[0.38] border-gray-100/30 rounded-3xl shadow-md backdrop-blur-xl p-8 sm:p-10"
    ...
    return (
        <>
                ...
                <div className={pageContainer}>
                    <div className="text-center">
                        ...
                        <img
                            ...
                            className="block mx-auto mb-8 w-full max-w-md rounded-2xl"
                        />
            ...
            <main className="flex flex-col space-y-16 sm:space-y-20">
                ...
                <section className={sectionPadding}>
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <h2 className="text-xl sm:text-2xl font-bold text-[#062447] mb-8 leading-relaxed">
                            判断できないのは「整理」していないから
                        </h2>
                    ...
                    <div className="mt-8">
                        <img
                            ...
                            className="w-full max-w-[560px] mx-auto rounded-3xl shadow-md"
                        />
                    </div>
                    ...
                    {/* 3ステップ図解など */}
                    <div className="max-w-3xl mx-auto mt-10 sm:mt-12 space-y-6 sm:space-y-8">

                        {/* 3ステップ図解 */}
                        <div className="space-y-4">
                            {/* STEP 1: 考えが散らかっている */}
                            <div className="rounded-3xl border border-[#7DD3FC]/40 border-gray-100/50 bg-gradient-to-br from-[#F0F9FF] to-[#E0F2FE] p-8 sm:p-10 shadow-sm">
                            ...
                            {/* STEP 2: 状況を整理する */}
                            <div className="rounded-3xl border border-[#38BDF8]/40 border-gray-100/50 bg-gradient-to-br from-[#E0F2FE] to-[#BAE6FD] p-8 sm:p-10 shadow-sm">
                                <div className="flex items-start gap-4">
                            ...
                            {/* STEP 3: 進む方向が見える */}
                            <div className="rounded-3xl border border-[#0EA5E9]/40 border-gray-100/50 bg-gradient-to-br from-[#BAE6FD] to-[#7DD3FC] p-8 sm:p-10 shadow-sm">
                                <div className="flex items-start gap-4">
                                    <div className="text-3xl sm:text-4xl flex-shrink-0">🧭</div>
                                    <div>
                ...
                {/* ========== ③ こんな方に向いています ========== */}
                <section className={sectionPadding}>
                    <div className={`${sectionInner} space-y-8 sm:space-y-10`}>
                    ...
                    <div className={`${sectionInner} space-y-8 sm:space-y-10`}>
                        ...
                        <div className={`${largeCard} pb-10 sm:pb-12`}>
                            <div className="flex flex-col items-center text-center mb-6">
                                ...
                                <p className="text-[#062447]/50 text-base sm:text-lg mb-4">不動産お悩み整理担当</p>
                                {/* 資格バッジ（宅地建物取引士のみ） */}
                                <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-6">
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#1D2B44] text-white text-xs sm:text-sm font-bold shadow-md">
                                        <span className="text-[#7DD3FC]" aria-hidden>◆</span> 宅地建物取引士
                                    </span>
                                </div>
                                {/* 実績の数値化 */}
                                <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full max-w-[480px] sm:max-w-[600px] mx-auto">
                                    <div className="rounded-2xl bg-[#E8F6FF]/90 border border-[#1D2B44]/15 border-gray-100/50 px-2 sm:px-4 py-5 sm:py-6 text-center min-w-0 shadow-sm">
                                        <p className="text-lg sm:text-2xl lg:text-3xl text-[#1D2B44] leading-tight whitespace-nowrap">
                                            業界歴<span className="font-bold">10年</span>
                                        </p>
                                        <p className="text-[#062447]/60 text-xs sm:text-sm mt-1">不動産の現場経験</p>
                                    </div>
                                    <div className="rounded-2xl bg-[#E8F6FF]/90 border border-[#1D2B44]/15 border-gray-100/50 px-2 sm:px-4 py-5 sm:py-6 text-center min-w-0 shadow-sm">
                                        <p className="text-lg sm:text-2xl lg:text-3xl text-[#1D2B44] leading-tight whitespace-nowrap">
                                            累計<span className="font-bold">100件超</span>
                                        </p>
                                        <p className="text-[#062447]/60 text-xs sm:text-sm mt-1">多くの方の悩みを解決</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                {[
                                    ...
                                    <div
                                        key={i}
                                        className="bg-white/50 border border-white/40 border-gray-100/50 rounded-2xl px-6 py-4 text-center text-[#062447]/80 text-sm font-medium shadow-sm"
                                    >
                                        {item}
                                    </div>
                                ))}
                    ...
                    <div className={`${sectionInner} space-y-8 sm:space-y-10`}>
                        ...
                        <div className={cardStack}>
                            {[
                                ...
                                <div key={i} className="bg-white/[0.55] border border-white/[0.35] border-gray-100/50 rounded-3xl shadow-md backdrop-blur-xl px-8 py-6 sm:px-10 sm:py-8">
                                    {/* Q（ぶら下げインデント：余白調整済み） */}
                ...
                <section id="form" className={sectionPadding}>
                    <div className={`${sectionInner} space-y-8 sm:space-y-10`}>
                        ...
                        {/* CTA直上テキスト（連結デザイン：1枚の角丸白パネル・親で背景と角丸を担当） */}
                        <div className="w-full max-w-3xl mx-auto rounded-[32px] overflow-hidden bg-white shadow-md border border-gray-100">
                            {/* ① 上イラスト - blockで画像下の隙間を除去 */}
                            <img
                                src={section03MessageVsCallUp}
                                alt=""
                                className="block w-full align-bottom"
                            />
                            {/* ② 中段テキスト - py-10維持・親幅に合わせた左右余白 */}
                        ...
                        {/* ✅ 状況整理カード */}
                        <div className="mx-auto w-full max-w-2xl bg-white/[0.62] border border-white/[0.38] border-gray-100/50 rounded-3xl shadow-md backdrop-blur-xl p-8 sm:p-10">
                            <div className="text-center">
                                <p className="text-[#062447]/60 text-sm mb-4">
                                    まずはこちらから<br />
                                    「相談希望」とメッセージを送ってください
                                </p>
                                <ShineAnchor
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="block w-full py-4 text-lg font-bold text-white bg-[#06c755] hover:bg-[#05b64c] rounded-2xl shadow-lg transition duration-200"
                                >
                                    LINEで相談する（無料）
                                </ShineAnchor>
                                <p className="mt-4 text-[#062447]/50 text-xs">
                                    ※ 自動応答ではありません。<br />
                                    Taka本人が直接お返事します。
                                </p>
                            </div>
                        ...
                        {/* メール相談フォーム（showMailFormがtrueの時のみ表示） */}
                        {showMailForm && (
                            <div className={largeCard}>
                                <div className="text-center mb-8">
                                    <h3 className="text-xl font-bold text-[#062447] mb-2">メールでのご相談はこちら</h3>
                                </div>

                                <form onSubmit={handleSubmit} className="space-y-6">
                                    {/* お名前 */}
                                    <div>
                                        <label htmlFor="name" className="block text-sm font-bold text-[#062447] mb-2">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 rounded-2xl border border-[#062447]/20 bg-white/50 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                                        />
                                    </div>

                                    {/* 連絡先 */}
                                    <div>
                                        <label htmlFor="contact" className="block text-sm font-bold text-[#062447] mb-2">
                                            連絡先（電話番号 または メール） <span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="contact"
                                    ...
                                    {/* 相談カテゴリ */}
                                    <div>
                                        <label htmlFor="category" className="block text-sm font-bold text-[#062447] mb-2">
                                            相談カテゴリ（複数回答可）
                                        </label>
                                        <select
                                            id="category"
                                        ...
                                        >
                                            ...
                                            <option value="売却について">売却について</option>
                                            <option value="購入について">購入について</option>
                                            <option value="相続について">相続について</option>
                                            <option value="住み替えについて">住み替えについて</option>
                                    ...
                                    {/* 相談内容 */}
                                    <div>
                                        <label htmlFor="message" className="block text-sm font-bold text-[#062447] mb-2">
                                            ご相談内容
                                        </label>
                                        <textarea
                                            id="message"
                                            name="message"
                                            rows="5"
                                            placeholder="現状のお悩みや、整理したいことなどをご自由にお書きください"
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full py-4 bg-[#0A2540] hover:bg-[#143D66] text-white font-bold rounded-2xl shadow-lg transition disabled:opacity-50"
                                        disabled={isSubmitted}
                                    >
                                        {isSubmitted ? '送信しました' : '送信する'}
                                    </button>
                                </form>
                            </div>
                        )}

                        {/* お問い合わせ方法の切り替え案内（今は非表示） */}
                        <div className="text-center text-[#062447]/40 text-xs">
                            <p>※ 現在はLINEでのご相談を推奨しております</p>
                        </div>
                    </div>
                </section>
